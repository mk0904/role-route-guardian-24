    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6">
        <div className="max-w-4xl w-full text-center space-y-8">
          ...
          <p className="text-sm text-slate-600 max-w-2xl mx-auto">
            Streamline visits, track performance, and manage branch health with
        ...
        {/* Features Grid */}
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-8 pt-16 max-w-6xl w-full">
          {[
            {
              icon: <Building2 className="h-8 w-8 text-blue-600" />,
              title: "Branch Management",
              description:
                "Efficiently manage branch visits with detailed tracking and reporting",
            },
            {
              icon: <Users className="h-8 w-8 text-blue-600" />,
              title: "Role-Based Access",
              description:
                "Different dashboards for Branch Heads, Zonal Heads, and Cluster Heads",
            },
            {
              icon: <BarChart3 className="h-8 w-8 text-blue-600" />,
              title: "Performance Analytics",
              description:
                "Track branch performance metrics and generate insights",
            },
          ].map((feature, i) => (
            <div
              key={i}
        ...
        <div className="mt-20 bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-4xl w-full">
          <div className="text-center space-y-4">
            <h2 className="text-2xl font-bold text-slate-800">
              Ready to Transform Your Branch Management?
            </h2>
      ...
      <footer className="py-8 border-t border-slate-200 bg-white mt-20">
        <div className="max-w-7xl mx-auto px-6 text-center text-slate-500 text-sm">
          &copy; {new Date().getFullYear()} Branch Visit Management System. All
          rights reserved.
        </div>
      </footer>
    </div>
